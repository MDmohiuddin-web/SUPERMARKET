        ...
        <div>
            <footer className="bg-white">
                <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
                            <div>
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li>
                                        <a className="text-gray-700 transition hover:opacity-75"> 1on1 Coaching </a>
                                    </li>

                                    <li>
                                        <a className="text-gray-700 transition hover:opacity-75"> Company Review </a>
                                    </li>
                                    ...
                                    <li>
                                        <a className="text-gray-700 transition hover:opacity-75"> HR Consulting </a>
                                    </li>

                                    <li>
                                        <a className="text-gray-700 transition hover:opacity-75"> SEO Optimisation </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <p className="text-xs text-gray-500">&copy; 2024. SUPERMARKET. All rights reserved.</p>
                </div>
            </footer>
        </div>
    );
